...
import com.example.springmvc.solution.dao.PersonDAO;
...
public class PeopleController {
    ...
    @GetMapping("/{id}")
    public String show(@PathVariable("id") int id, Model model){ //@PathVariable достает указаное значение (id) из запроса
